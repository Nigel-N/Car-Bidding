...
const EditBidCars = () => {
    ...
    const handleEdit = () => {
        ...
        // Axios.put(`http://localhost:5000/updateCars/${id}`,
        {
            orgRegistration: orgRegistration, ownership: ownership, mileage: mileage, minPARF: minPARF, paperValue: paperValue, 
            ...
            unladenWeight: unladenWeight, bidDate: formBidDate
        })
        alert('The car is successfully edited')
    ...
    const getDetails = async () => {
        try {
            const data = await Axios.get(`${url}/adminBidCarsDetails/${id}`);
            // const data = await Axios.get(`http://localhost:5000/adminBidCarsDetails/${id}`);
    ...
    return (
        ...
        <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            <Grid item xs={12} sx={{ mb: -2.25 }} style={{ display: 'flex' }}>
                <Typography variant="h5">&nbsp;Edit&nbsp;Car&nbsp;Form</Typography>
            </Grid>
            <br></br>
                                                ...
                                                .map((item) => {
                                                    return(
                                                        <>
                                                                ...
                                                                <TableBody item xs={2.4} sm={2.4} md={2.4} lg={2.4}>
                                                                            ...
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(onFilterSelectedDate) => {
                                                                                    ...
                                                                                    if (onFilterSelectedDate != ''){
                                                                                        ...
                                                                                        setOrgRegistration(item.OrgRegistration)
                                                                                    }
                                                                                }}
                                                                            />
                                                                            <Typography variant="h6">{item.OrgRegistration}</Typography>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Ownership</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.Ownership} onChange={(e) => {
                                                                                setOwnership(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Mileage</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.Milleage} onChange={(e) => {
                                                                                setMileage(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Min.PARF</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.MinPARF} onChange={(e) => {
                                                                                setMinPARF(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Paper Value</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.PaperValue} onChange={(e) => {
                                                                                ...
                                                                                <DatePicker
                                                                                    ...
                                                                                    onChange={(onFilterSelectedDate) => {
                                                                                        ...
                                                                                        if (onFilterSelectedDate != ''){
                                                                                            ...
                                                                                            setCOEExpiry(item.COEExpiry)
                                                                                        }
                                                                                    }}
                                                                                />
                                                                                <Typography variant="h6">{item.COEExpiry}</Typography>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            ...
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(onFilterSelectedDate) => {
                                                                                    ...
                                                                                    if (onFilterSelectedDate != ''){
                                                                                        ...
                                                                                        setFormRoadTaxExpiry(item.RoadTaxExpiry)
                                                                                    }
                                                                                }}
                                                                            />
                                                                            <Typography variant="h6">{item.RoadTaxExpiry}</Typography>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Vehicle Code</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.VehicleCode} onChange={(e) => {
                                                                                setVehicleCode(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Manu.Year</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.ManuYear} onChange={(e) => {
                                                                                setManuYear(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Colour</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.Color} onChange={(e) => {
                                                                            ...
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(onFilterSelectedDate) => {
                                                                                    ...
                                                                                    if (onFilterSelectedDate != ''){
                                                                                        ...
                                                                                        setFirstRegistration(item.FirstRegistration)
                                                                                    }
                                                                                }}
                                                                            />
                                                                            <Typography variant="h6">{item.FirstRegistration}</Typography>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            ...
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(onFilterSelectedDate) => {
                                                                                    ...
                                                                                    if (onFilterSelectedDate != ''){
                                                                                        ...
                                                                                        setInspectionDue(item.InspectionDue)
                                                                                    }
                                                                                }}
                                                                            />
                                                                            <Typography variant="h6">{item.InspectionDue}</Typography>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">COE Category</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.COECategory} onChange={(e) => {
                                                                                setCOECategory(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Engine Capacity</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.EngineCapacity} onChange={(e) => {
                                                                            ...
                                                                            <DatePicker
                                                                                ...
                                                                                onChange={(onFilterSelectedDate) => {
                                                                                    ...
                                                                                    if (onFilterSelectedDate != ''){
                                                                                        ...
                                                                                        setPARFExpiryDate(item.PARFExpiryDate)
                                                                                    }
                                                                                }}
                                                                            />
                                                                            <Typography variant="h6">{item.PARFExpiryDate}</Typography>
                                                                        </TableCell>
                                                                    </TableRow>
                                                                    <TableRow>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Transmission</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.Transmission} onChange={(e) => {
                                                                                setTransmission(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">COE Period</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.COEPeriod} onChange={(e) => {
                                                                                setCOEPeriod(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Power</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.Power} onChange={(e) => {
                                                                                setPower(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Accident Free</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.AccidentFree} onChange={(e) => {
                                                                                setAccidentFree(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Engine No.</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.EngineNo} onChange={(e) => {
                                                                    ...
                                                                    <TableRow>
                                                                        <TableCell>
                                                                            ...
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.COE} onChange={(e) => {
                                                                                setCOE(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Vehicle Attachment</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.VehicleAttachment} onChange={(e) => {
                                                                                setVehicleAttachment(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Purchase From</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.PurchaseFrom} onChange={(e) => {
                                                                                setPurchaseFrom(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Chassis No.</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.ChassisNo} onChange={(e) => {
                                                                                setChassisNo(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">OMV</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.OMV} onChange={(e) => {
                                                                    ...
                                                                    <TableRow>
                                                                        <TableCell>
                                                                            ...
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.MaxLadenWeight} onChange={(e) => {
                                                                                setMaxLadenWeight(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Veh. Scheme</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.VehScheme} onChange={(e) => {
                                                                                setVehScheme(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Fuel Type</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.FuelType} onChange={(e) => {
                                                                                setFuelType(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">ARF</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.ARF} onChange={(e) => {
                                                                                setARF(e.target.value)
                                                                            }}/>
                                                                        </TableCell>
                                                                        <TableCell>
                                                                            <Typography variant="h6">Unlanden Weight</Typography>
                                                                            <TextField id="outlined-basic" variant="outlined" defaultValue={item.UnladenWeight} onChange={(e) => {
                                                            ...
                                                            <TableRow>
                                                                    <Button variant="contained" onClick={ handleEdit }>Edit Car</Button>
                                                                &nbsp;&nbsp;
                                                                <Button
                                                                    variant="contained" 
