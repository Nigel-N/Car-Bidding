...
const AdminBid = ({ title, car, mybid, color, status, carlogo, date, index, deleteIcon, bidCarID }) => {
            ...
            <Card sx={{ position: 'relative', borderRadius: '25px 25px 10px 10px' }}>
                ...
                >
                    ...
                    <InfoStyle>
                        ...
                        >
                            <Iconify icon="clarity:date-line" sx={{ width: 13, height: 13, mr: 0.5 }} />
                            <Typography variant="caption1" sx={{ color: '#919eab' }}>
                                {date}&nbsp;&nbsp;&nbsp;
                            </Typography>
                            <Iconify icon="fluent:document-search-24-regular" sx={{ width: 13, height: 13, mr: 0.5 }} />
...
AdminBid.propTypes = {
    ...
    bidCarID: PropTypes.number,
};

AdminBid.defaultProps = {
    color: 'primary'
};
